...
<html lang="en" dir="ltr">
    ...
    <!-- login box -->
        <form class="box" action="Konek.php" method="post">
        <img class="mb-4" src="assets/logo-penman.png" alt="" width="250" height="115">
            <h1>Login</h1>
            <!-- Error Message -->
            ...
            <a href="../SignUp_Aulia/signup.html"></br>Sudah ada akun?</br></a>
            &copy; 2021
        </form>
